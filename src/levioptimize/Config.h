...
struct Config {
    ...
    struct {
        ...
        Dispatcher<bool, inventory_transaction_patch::InventoryTransactionPatch>  patchInventoryTransaction = true;
        Dispatcher<bool, itemstack_userdata_opt::ItemStackUserDataOpt>            optItemStackUserData      = true;
